...
const ChatItem: React.FC<ChatItemProps> = ({
  ...
  return (
    <li>
      <button
        className="flex flex-row space-x-2 items-center w-full p-3 hover:bg-gray-50 dark:hover:bg-dark cursor-pointer"
        onClick={() =>
          handleSelect({
            chatId,
            uid,
      ...
      >
        ...
        <div className="w-8/12 h-full flex flex-col justify-start text-start">
